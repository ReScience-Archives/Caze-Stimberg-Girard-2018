...
\marginpar{
  ...
  {\bfseries Received}  January 26, 2018\\
  {\bfseries Accepted}  April 23 2018\\
  {\bfseries Published} May 12, 2018\\
  ...
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Caze-Stimberg-Girard-2018/tree/master/article}{\faGithubAlt~Article repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Caze-Stimberg-Girard-2018/tree/master/code}{\faGithubAlt~Code repository}
  \end{repobox}
        \hypersetup{urlcolor=blue}
}
