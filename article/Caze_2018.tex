...
We added 1-50 spikes ``in transit'' to better match the results from the gridsearch. The spike ``in transit'' addition or substraction fail to modify the outcome.  
