...
\textbf{Evolution of synchronous pulses in linearly (A) and non-linearly (B) coupled networks, corrected for the background activity.} All conventions as in Fig.~\ref{fig:markov_correction}. Without correction (see text)}
\end{figure}
\end{document}
