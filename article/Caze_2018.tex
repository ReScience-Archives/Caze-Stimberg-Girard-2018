...
\textbf{Using max instead of mean to color each pixels.} All conventions as in Fig.~\ref{fig:grid}, but points are coloured according the observed qualitative behaviour that occurred the most often among the 10 independent simulations for given connection strengths.}
\end{figure}
